...
public class CursosbApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat7 = new Categoria(null,"Cama");
		...
		Pedido ped1 = new Pedido(null,sdf.parse("20/02/2021 10:00"),cli1,e1);
		Pedido ped2 = new Pedido(null,sdf.parse("21/02/2021 14:00"),cli1,e2);
